...
class Game:
    def __init__(self):
        self.redBall = Ball(Vector2(utils.width/2 + random.randint(-30,30),utils.height/2 + random.randint(-30,30)),2,(255,0,0))
        self.blueBall = Ball(Vector2(utils.width/2 + random.randint(-30,30),utils.height/2 + random.randint(-30,30)),2,(0,0,255))
